...
class Ui_SamtatReport(object):
    def setupUi(self, SamtatReport):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(".\\../../../Pictures/qt/164410155261feffb06ae49-main.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SamtatReport.setWindowIcon(icon)
        SamtatReport.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(SamtatReport)
        self.centralwidget.setObjectName("centralwidget")
        self.comboBox_vehicle_class = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_vehicle_class.setGeometry(QtCore.QRect(70, 140, 151, 22))
        self.comboBox_vehicle_class.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"background-color: rgb(255, 255, 255);")
        self.comboBox_vehicle_class.setObjectName("comboBox_vehicle_class")
        self.comboBox_vehicle_class.addItem("")
        self.comboBox_vehicle_class.addItem("")
        self.comboBox_vehicle_class.addItem("")
        ...
        self.comboBox_istgah.addItem("")
        self.comboBox_istgah.addItem("")
        self.takhalof_tick = QtWidgets.QCheckBox(self.centralwidget)
        self.takhalof_tick.setGeometry(QtCore.QRect(210, 180, 16, 17))
        self.takhalof_tick.setText("")
        self.takhalof_tick.setObjectName("takhalof_tick")
    ...
    def retranslateUi(self, SamtatReport):
        ...
        SamtatReport.setWindowTitle(_translate("SamtatReport", "samtat"))
        self.comboBox_vehicle_class.setItemText(0, _translate("SamtatReport", "همه نوع"))
        self.comboBox_vehicle_class.setItemText(1, _translate("SamtatReport", "سبک"))
        self.comboBox_vehicle_class.setItemText(2, _translate("SamtatReport", "سنگین"))
